...
(defun import-js-handle-imports (process import-data)
...
(defun import-js-handle-goto (process import-data)
...
(defun import-js-import ()
  ...
  (interactive)
  (save-some-buffers)
  (if (not import-js-process)
      (message "import-js daemon not running")
    (set-process-filter import-js-process 'import-js-handle-imports)
...
(defun import-js-goto ()
  ...
  (if (not import-js-process)
      (message "import-js daemon not running")
    (set-process-filter import-js-process 'import-js-handle-goto)
